          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="bg-white rounded-xl shadow-2xl p-2 flex flex-col sm:flex-row gap-2">
                ...
                <button className="bg-[#06B6D4] text-white px-6 sm:px-8 py-4 rounded-lg font-semibold hover:bg-opacity-90 transition-all shadow-md hover:shadow-lg flex items-center justify-center">
